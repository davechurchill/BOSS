...
GameState GetZergStartState()
{
    ...
    BuildOrder bo;
    std::vector<std::string> bos = { "SpawningPool", "Drone", "Drone", "Drone", "Drone"};
...
void test()
{
    ...
    bos = { "Drone", "Drone", "Hatchery", "Overlord", "Drone", "Extractor", "HydraliskDen", "Hydralisk", "Lair", "LurkerAspect", "Lurker", "CreepColony", "SunkenColony", "Spire"};
